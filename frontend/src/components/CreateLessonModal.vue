...
import type { Course, CourseTreeNode, Theme } from '@/api/types'
            ...
            <div class="space-y-3">
              ...
              <div v-if="!selectedFile">
                <button
                  ...
                  @drop="onDrop"
                  :class="[
                    'w-full min-h-[260px] flex flex-col items-center justify-center px-6 py-8 border-2 border-dashed rounded-lg transition-colors',
                    isDragging
